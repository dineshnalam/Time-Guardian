...
import 'package:timegaurdian/utils/auto_size_text/auto_size_text.dart';
...
BubbleBottomBarItem tab(String iconData, String tabName) {
  return BubbleBottomBarItem(
      backgroundColor: Color(0XFF5959fc),
      icon: SvgPicture.asset(
        iconData,
        color: Color(0XFF5959fc),
      ),
      activeIcon: SvgPicture.asset(iconData, height: 20, width: 20, color: t5ColorPrimary),
      title: AutoSizeText(tabName, style: TextStyle(fontSize: textSizeMedium, fontFamily: fontMedium, color: black), maxLines: 1));
}
